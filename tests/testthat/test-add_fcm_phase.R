...
testthat::test_that("Check for missing columns", {
  ...
  testthat::expect_error(add_fcm_phase(
    .dataset = test_df %>% dplyr::select(-fsl_hhs_cat_ipc),
...
testthat::test_that("Checking column values hhs - [None/No or Little/Moderate/Severe/Very Severe]", {
  ...
  set.seed(30)
  test_df[sample.int(nrow(test_df), 3), c("fsl_hhs_cat_ipc")] <- "none"
  set.seed(29)
  test_df[sample.int(nrow(test_df), 3), c("fsl_hhs_cat_ipc")] <- "little"

  set.seed(12)
  test_df[sample.int(nrow(test_df), 3), c("fsl_hhs_cat_ipc")] <- "random_value"
  testthat::expect_error(add_fcm_phase(
    .dataset = test_df
    ))
})
...
testthat::test_that("Checking column values rcsi - [No to Low/Medium/High]", {
  ...
  set.seed(30)
  test_df[sample.int(nrow(test_df), 3), c("fsl_rcsi_cat")] <- "none"
  set.seed(29)
  test_df[sample.int(nrow(test_df), 3), c("fsl_rcsi_cat")] <- "med"

  set.seed(12)
  test_df[sample.int(nrow(test_df), 3), c("fsl_rcsi_cat")] <- "random_value"
  testthat::expect_error(add_fcm_phase(
    .dataset = test_df
  ))
})
...
testthat::test_that("Checking column values fcs - [Acceptable/Poor/Borderline]", {
  ...
  set.seed(30)
  test_df[sample.int(nrow(test_df), 3), c("fsl_fcs_cat")] <- "accep"
  set.seed(29)
  test_df[sample.int(nrow(test_df), 3), c("fsl_fcs_cat")] <- "poor"

  set.seed(12)
  test_df[sample.int(nrow(test_df), 3), c("fsl_fcs_cat")] <- "random_value"
  testthat::expect_error(add_fcm_phase(
    .dataset = test_df
  ))
})
...
testthat::test_that("Checking column values hdds - [Low/Medium/High]", {
  ...
  set.seed(30)
  test_df[sample.int(nrow(test_df), 3), c("fsl_hdds_cat")] <- "low"
  set.seed(29)
  test_df[sample.int(nrow(test_df), 3), c("fsl_hdds_cat")] <- "Very High"

  set.seed(12)
  test_df[sample.int(nrow(test_df), 3), c("fsl_hdds_cat")] <- "random_value"
  testthat::expect_error(add_fcm_phase(
    .dataset = test_df
  ))
})
...
testthat::test_that("check if function producing expected output with (FCS/RCSI/HHS)", {
  ...
  expected_output_success <- test_df |>
    dplyr::mutate(fsl_fc_cell = dplyr::case_when(
      ...
      fsl_fcs_cat == "Acceptable" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "None" ~ 16,
      fsl_fcs_cat == "Poor" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "None" ~ 26,
      fsl_fcs_cat == "Borderline" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "None" ~ 21,
      ...
      fsl_fcs_cat == "Acceptable" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Moderate" ~ 18,
      fsl_fcs_cat == "Poor" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Moderate" ~ 28,
      fsl_fcs_cat == "Borderline" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Moderate" ~ 23,
      fsl_fcs_cat == "Acceptable" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Moderate" ~ 33,
      fsl_fcs_cat == "Poor" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Moderate" ~ 43,
      fsl_fcs_cat == "Borderline" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Moderate" ~ 38,
      fsl_fcs_cat == "Acceptable" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Severe" ~ 4,
      fsl_fcs_cat == "Poor" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Severe" ~ 14,
      fsl_fcs_cat == "Borderline" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Severe" ~ 9,
      fsl_fcs_cat == "Acceptable" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Severe" ~ 19,
      fsl_fcs_cat == "Poor" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Severe" ~ 29,
      fsl_fcs_cat == "Borderline" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Severe" ~ 24,
      fsl_fcs_cat == "Acceptable" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Severe" ~ 34,
      fsl_fcs_cat == "Poor" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Severe" ~ 44,
      fsl_fcs_cat == "Borderline" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Severe" ~ 39,
      fsl_fcs_cat == "Acceptable" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Very Severe" ~ 5,
      fsl_fcs_cat == "Poor" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Very Severe" ~ 15,
      fsl_fcs_cat == "Borderline" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Very Severe" ~ 10,
      fsl_fcs_cat == "Acceptable" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Very Severe" ~ 20,
      fsl_fcs_cat == "Poor" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Very Severe" ~ 30,
      fsl_fcs_cat == "Borderline" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Very Severe" ~ 25,
      fsl_fcs_cat == "Acceptable" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Very Severe" ~ 35,
      fsl_fcs_cat == "Poor" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Very Severe" ~ 45,
...
testthat::test_that("check if function producing expected output with (HDDS/RCSI/HHS)", {
  ...
  expected_output_success <- test_df |>
    dplyr::mutate(fsl_fc_cell = dplyr::case_when(
      ...
      fsl_hdds_cat == "High" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "None" ~ 16,
      fsl_hdds_cat == "Low" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "None" ~ 26,
      fsl_hdds_cat == "Medium" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "None" ~ 21,
      ...
      fsl_hdds_cat == "High" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Moderate" ~ 18,
      fsl_hdds_cat == "Low" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Moderate" ~ 28,
      fsl_hdds_cat == "Medium" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Moderate" ~ 23,
      fsl_hdds_cat == "High" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Moderate" ~ 33,
      fsl_hdds_cat == "Low" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Moderate" ~ 43,
      fsl_hdds_cat == "Medium" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Moderate" ~ 38,
      fsl_hdds_cat == "High" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Severe" ~ 4,
      fsl_hdds_cat == "Low" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Severe" ~ 14,
      fsl_hdds_cat == "Medium" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Severe" ~ 9,
      fsl_hdds_cat == "High" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Severe" ~ 19,
      fsl_hdds_cat == "Low" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Severe" ~ 29,
      fsl_hdds_cat == "Medium" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Severe" ~ 24,
      fsl_hdds_cat == "High" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Severe" ~ 34,
      fsl_hdds_cat == "Low" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Severe" ~ 44,
      fsl_hdds_cat == "Medium" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Severe" ~ 39,
      fsl_hdds_cat == "High" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Very Severe" ~ 5,
      fsl_hdds_cat == "Low" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Very Severe" ~ 15,
      fsl_hdds_cat == "Medium" & fsl_rcsi_cat == "No to Low" & fsl_hhs_cat_ipc == "Very Severe" ~ 10,
      fsl_hdds_cat == "High" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Very Severe" ~ 20,
      fsl_hdds_cat == "Low" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Very Severe" ~ 30,
      fsl_hdds_cat == "Medium" & fsl_rcsi_cat == "Medium" & fsl_hhs_cat_ipc == "Very Severe" ~ 25,
      fsl_hdds_cat == "High" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Very Severe" ~ 35,
      fsl_hdds_cat == "Low" & fsl_rcsi_cat == "High" & fsl_hhs_cat_ipc == "Very Severe" ~ 45,
...
testthat::test_that("check if function producing expected output with (FCS/HHS)", {
  ...
  expected_output_success <- test_df |>
    dplyr::mutate(fsl_fc_cell = dplyr::case_when(
      ...
      fsl_fcs_cat == "Acceptable" & fsl_hhs_cat_ipc == "Severe" ~ 4,
      fsl_fcs_cat == "Poor" & fsl_hhs_cat_ipc == "Severe" ~ 14,
      fsl_fcs_cat == "Borderline" & fsl_hhs_cat_ipc == "Severe" ~ 9,
      fsl_fcs_cat == "Acceptable" & fsl_hhs_cat_ipc == "Very Severe" ~ 5,
      fsl_fcs_cat == "Poor" & fsl_hhs_cat_ipc == "Very Severe" ~ 15,
...
testthat::test_that("check if function producing expected output with (HDDS/HHS)", {
  ...
  expected_output_success <- test_df |>
    dplyr::mutate(fsl_fc_cell = dplyr::case_when(
      ...
      fsl_hdds_cat == "High" & fsl_hhs_cat_ipc == "Severe" ~ 4,
      fsl_hdds_cat == "Low" & fsl_hhs_cat_ipc == "Severe" ~ 14,
      fsl_hdds_cat == "Medium" & fsl_hhs_cat_ipc == "Severe" ~ 9,
      fsl_hdds_cat == "High" & fsl_hhs_cat_ipc == "Very Severe" ~ 5,
      fsl_hdds_cat == "Low" & fsl_hhs_cat_ipc == "Very Severe" ~ 15,
