...
if(!file.exists("inputs/environment.Rdata")) {
  ...
  ## Detect age month
  age_months <- names(raw.iycf)[grepl("month|age",names(raw.iycf))]
  ...
  iycf_1 <- names(raw.iycf)[grepl("iycf_1|ever",names(raw.iycf))]
  if(length(iycf_1) == 1){
  ...
  iycf_2 <- names(raw.iycf)[grepl("iycf_2|bf_ei|breastfed",names(raw.iycf))]
  if(length(iycf_2) == 1){
  ...
  iycf_4 <- names(raw.iycf)[grepl("iycf_4|yesterday",names(raw.iycf))]
  if(length(iycf_4) == 1){
  ...
  iycf_5 <- names(raw.iycf)[grepl("iycf_5|bottlefed",names(raw.iycf))]
  if(length(iycf_5) == 1){
  ...
  iycf_6a <- names(raw.iycf)[grepl("iycf_6a|water",names(raw.iycf))]
  if(length(iycf_6a) == 1){
  ...
  iycf_6b <- names(raw.iycf)[grepl("iycf_6b|formula",names(raw.iycf))]
  if(length(iycf_6b) == 1){
  ...
  iycf_6c <- names(raw.iycf)[grepl("iycf_6c|milk",names(raw.iycf))]
  if(length(iycf_6c) == 1){
  ...
  iycf_6d <- names(raw.iycf)[grepl("iycf_6d|yoghurt",names(raw.iycf))]
  if(length(iycf_6d) == 1){
  ...
  iycf_6e <- names(raw.iycf)[grepl("iycf_6e|chocolate",names(raw.iycf))]
  if(length(iycf_6e) == 1){
  ...
  iycf_6f <- names(raw.iycf)[grepl("iycf_6f|juice",names(raw.iycf))]
  if(length(iycf_6f) == 1){
  ...
  iycf_6g <- names(raw.iycf)[grepl("iycf_6g|soda",names(raw.iycf))]
  if(length(iycf_6g) == 1){
  ...
  iycf_6h <- names(raw.iycf)[grepl("iycf_6h|tea",names(raw.iycf))]
  if(length(iycf_6h) == 1){
  ...
  iycf_6i <- names(raw.iycf)[grepl("iycf_6i|broth",names(raw.iycf))]
  if(length(iycf_6i) == 1){
  ...
  iycf_6j <- names(raw.iycf)[grepl("iycf_6j|other",names(raw.iycf))]
  if(length(iycf_6j) == 1){
  ...
  iycf_7a <- names(raw.iycf)[grepl("iycf_7a|yoghurt",names(raw.iycf))]
  if(length(iycf_7a) == 1){
  ...
  iycf_7b <- names(raw.iycf)[grepl("iycf_7b|cereals",names(raw.iycf))]
  if(length(iycf_7b) == 1){
  ...
  iycf_7c <- names(raw.iycf)[grepl("iycf_7c|orange|pumkin",names(raw.iycf))]
  if(length(iycf_7c) == 1){
  ...
  iycf_7d <- names(raw.iycf)[grepl("iycf_7d|roots",names(raw.iycf))]
  if(length(iycf_7d) == 1){
  ...
  iycf_7e <- names(raw.iycf)[grepl("iycf_7e|greens|leaf",names(raw.iycf))]
  if(length(iycf_7e) == 1){
  ...
  iycf_7f <- names(raw.iycf)[grepl("iycf_7f|other_veg",names(raw.iycf))]
  if(length(iycf_7f) == 1){
  ...
  iycf_7g <- names(raw.iycf)[grepl("iycf_7g|fruit",names(raw.iycf))]
  if(length(iycf_7g) == 1){
  ...
  iycf_7h <- names(raw.iycf)[grepl("iycf_7h|other_fruit",names(raw.iycf))]
  if(length(iycf_7h) == 1){
  ...
  iycf_7i <- names(raw.iycf)[grepl("iycf_7i|organs",names(raw.iycf))]
  if(length(iycf_7i) == 1){
  ...
  iycf_7j <- names(raw.iycf)[grepl("iycf_7j|meat",names(raw.iycf))]
  if(length(iycf_7j) == 1){
  ...
  iycf_7k <- names(raw.iycf)[grepl("iycf_7k|other_meat",names(raw.iycf))]
  if(length(iycf_7k) == 1){
  ...
  iycf_7l <- names(raw.iycf)[grepl("iycf_7l|egg",names(raw.iycf))]
  if(length(iycf_7l) == 1){
  ...
  iycf_7m <- names(raw.iycf)[grepl("iycf_7m|fish",names(raw.iycf))]
  if(length(iycf_7m) == 1){
  ...
  iycf_7n <- names(raw.iycf)[grepl("iycf_7n|legumes",names(raw.iycf))]
  if(length(iycf_7n) == 1){
  ...
  iycf_7o <- names(raw.iycf)[grepl("iycf_7o|cheese",names(raw.iycf))]
  if(length(iycf_7o) == 1){
  ...
  iycf_7p <- names(raw.iycf)[grepl("iycf_7p|sweet",names(raw.iycf))]
  if(length(iycf_7p) == 1){
  ...
  iycf_7q <- names(raw.iycf)[grepl("iycf_7q|crisps|fries",names(raw.iycf))]
  if(length(iycf_7q) == 1){
  ...
  iycf_7r <- names(raw.iycf)[grepl("iycf_7r|other",names(raw.iycf))]
  if(length(iycf_7r) == 1){
  ...
  iycf_8 <- names(raw.iycf)[grepl("iycf_8|mealfreq|solid",names(raw.iycf))]
  if(length(iycf_8) == 1){
  ...
  yes_answer <- tcltk::tk_select.list(unique(unlist(raw.iycf[,yes_no_columns])), title = "Yes Value")
  no_answer <- tcltk::tk_select.list(unique(unlist(raw.iycf[,yes_no_columns])) %>% unique, title = "No Value")
  dnk_answer <- tcltk::tk_select.list(unique(unlist(raw.iycf[,yes_no_columns])) %>% unique, title = "Don't Know Value")
  pnta_answer <- tcltk::tk_select.list(unique(unlist(raw.iycf[,yes_no_columns])) %>% unique, title = "Prefer Not To Answer Value")
  
  if(!is.null(iycf_2)){
    if(!is_empty_new("iycf_2")){
      iycf2_immediate_value <- tcltk::tk_select.list(unique(unlist(raw.iycf[,iycf_2])) %>% unique, title = "Immediately Value")
      iycf2_lessday_value <- tcltk::tk_select.list(unique(unlist(raw.iycf[,iycf_2])) %>% unique, title = "Less Than A Day Value")
      iycf2_moreday_value <- tcltk::tk_select.list(unique(unlist(raw.iycf[,iycf_2])) %>% unique, title = "More Than A Day Value")
    } else {
...
raw.flag.iycf <- raw.iycf %>%
  ...
  if(!file.exists("inputs/environment.Rdata")) {
    ...
    if(!is.null(iycf_caregiver)) {
      if(!is_empty_new("iycf_caregiver")) {
...
for(flag in flags_iycf_columns) {
  if(yes_no_team == "yes"){
    ...
    flag_action <- flag_description %>%
      filter(flag_name %in% flag) %>%
      dplyr::pull(Action)
    flag_by_team <- raw.flag.iycf %>%
      dplyr::select(team, enumerator, !!rlang::sym(flag)) %>%
      filter(!is.na(!!rlang::sym(flag))) %>%
      dplyr::mutate(flag := flag) %>%
      dplyr::group_by(flag,!!rlang::sym(team),!!rlang::sym(enumerator)) %>%
      dplyr::summarise(num_samples = n(),
                flagged = sum(!!rlang::sym(flag))) %>%
      dplyr::mutate(percentage_flagged = paste0(round((flagged/num_samples)*100,2),"%")) %>%
      dplyr::ungroup() %>%
      dplyr::select(-1)
    if(nrow(flag_by_team)>0){
      ...
      subch(DT::datatable(flag_by_team,
                    extensions = 'Buttons', options = list(
                      dom = 'Blfrtip',
                      buttons = c('copy', 'csv', 'excel', 'pdf'),
                      lengthMenu = list(c(50),
