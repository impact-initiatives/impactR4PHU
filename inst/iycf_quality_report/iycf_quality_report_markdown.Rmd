...
list_of_var <- c("uuid_main","team","yes_no_team","enumerator","iycf_caregiver",
                 ...
                 "iycf_6c_swt","iycf_6d_swt","iycf_6h_swt","iycf_6j_swt","yes_answer","no_answer","dnk_answer",
...
if(yes_no_team == "yes"){
  ...
  for (i in list_teams) {
    ...
    for(j in list_enum){
      ...
      overall_iycf_plaus_enum <- overall_iycf_plaus %>%
        ...
        cbind(bind) %>%
        dplyr::select(-group) %>%
        dplyr::left_join(result_iycf_pivot %>% dplyr::filter(group == j))
  ...
  for (i in list_enum) {
    ...
    overall_iycf_plaus_enum <- overall_iycf_plaus %>%
      ...
      cbind(bind) %>%
      dplyr::select(-group) %>%
      dplyr::left_join(result_iycf_pivot %>%
                  filter(group == i))
