...
label_colname <- tcltk::tk_select.list(names(readxl::read_excel(path.tool))[grepl("label",names(readxl::read_excel(path.tool)))], title = "Label column to choose", multiple = F)
