...
<h5>Number of detected entries with Respondent reported sex of dead person male and a cause of death related to female only:<strong> `r nrow(checks_followups %>% filter(check.id == 2))`</strong></h5>
<h5>Number of detected entries with Respondent reported wrong dates leading to a negative person time:<strong> `r nrow(checks_followups %>% filter(check.id == 3))`</strong></h5>
