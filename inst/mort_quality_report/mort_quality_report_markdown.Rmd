...
if(!file.exists("inputs/environment.Rdata")) {
  ...
  if(length(uuid_main) == 1){
    ...
    uuid_main <- tcltk::tk_select.list(uuid_main, title = "HH UUID Column")
  ...
  if(length(uuid_roster) == 1){
    ...
    uuid_roster <- tcltk::tk_select.list(uuid_roster, title = "HH UUID Column")
  ...
  if(length(sex_roster) == 1){
    ...
    sex_roster <- tcltk::tk_select.list(sex_roster, title = "Sex Column")
  ...
  if(length(age_roster) == 1){
    ...
    age_roster <- tcltk::tk_select.list(age_roster, title = "Age Column")
  ...
  if(length(joined_roster) == 1){
    ...
    joined_roster <- tcltk::tk_select.list(joined_roster, title = "Joined Column")
  ...
  if(length(joined_date_roster) == 1){
    ...
    joined_date_roster <- tcltk::tk_select.list(joined_date_roster, title = "Joined Date Column")
  ...
  if(length(birth_roster) == 1){
    ...
    birth_roster <- tcltk::tk_select.list(birth_roster, title = "Birth Column")
  ...
  if(length(birthdate_roster) == 1){
    ...
    birthdate_roster <- tcltk::tk_select.list(birthdate_roster, title = "Birth date Column")
  ...
  if(length(uuid_left) == 1){
    ...
    uuid_left <- tcltk::tk_select.list(uuid_left, title = "HH UUID Column")
  ...
  if(length(sex_left) == 1){
    ...
    sex_left <- tcltk::tk_select.list(sex_left, title = "sex date Column")
  ...
  if(length(age_left) == 1){
    ...
    age_left <- tcltk::tk_select.list(age_left, title = "age date Column")
  ...
  if(length(birth_left) == 1){
    ...
    birth_left <- tcltk::tk_select.list(birth_left, title = "Birth date Column")
  ...
  if(length(birthdate_left) == 1){
    ...
    birthdate_left <- tcltk::tk_select.list(birthdate_left, title = "Birth date Column")
  ...
  if(length(joined_left) == 1){
    ...
    joined_left <- tcltk::tk_select.list(joined_left, title = "Joined Column")
  ...
  if(length(joined_date_left) == 1){
    ...
    joined_date_left <- tcltk::tk_select.list(joined_date_left, title = "Joined date Column")
  ...
  if(length(left_date_left) == 1){
    ...
    left_date_left <- tcltk::tk_select.list(left_date_left, title = "Left date Column")
  ...
  if(length(uuid_died) == 1){
    ...
    uuid_died <- tcltk::tk_select.list(uuid_died, title = "HH UUID Column")
  ...
  if(length(sex_died) == 1){
    ...
    sex_died <- tcltk::tk_select.list(sex_died, title = "Sex date Column")
  ...
  if(length(age_died) == 1){
    ...
    age_died <- tcltk::tk_select.list(age_died, title = "Age date Column")
  ...
  if(length(birth_died) == 1){
    ...
    birth_died <- tcltk::tk_select.list(birth_died, title = "Birth Column")
  ...
  if(length(birthdate_died) == 1){
    ...
    birthdate_died <- tcltk::tk_select.list(birthdate_died, title = "Birth date Column")
  ...
  if(length(joined_died) == 1){
    ...
    joined_died <- tcltk::tk_select.list(joined_died, title = "Joined Column")
  ...
  if(length(joined_date_died) == 1){
    ...
    joined_date_died <- tcltk::tk_select.list(joined_date_died, title = "Joined date Column")
  ...
  if(length(date_death) == 1){
    ...
    date_death <- tcltk::tk_select.list(date_death, title = "Death date Column")
  } else if (length(date_death) == 0) {
    date_death <- svDialogs::dlg_input(message= "Enter the name of the death date column in died data","date_death")$res
  }
  
  ## Detect death_cause column
  death_cause <- names(raw.died_member)[grepl("final",names(raw.died_member))]
  ...
  death_location <- names(raw.died_member)[grepl("final",names(raw.died_member))]
  ...
  if(length(death_location) == 1){
    ...
    death_location <- tcltk::tk_select.list(death_location, title = "Location of Death Column")
  ...
  raw.main <- raw.main %>% 
    dplyr::mutate(!!rlang::sym(date_dc) := ifelse(is.na(!!rlang::sym(date_dc)), NA,
                                                  ifelse(nchar(!!rlang::sym(date_dc)) == 5,
                                                         ...
                                                         stringr::str_sub(string = start, start = 1, end = 10))),
                  !!rlang::sym(date_recall_event) := ifelse(is.na(!!rlang::sym(date_recall_event)), NA,
  ...
  raw.hh_roster <- raw.hh_roster %>% 
    dplyr::mutate(age_years = NULL,
                  !!rlang::sym(final_ind_dob) := ifelse(is.na(!!rlang::sym(final_ind_dob)), NA,
                                                  ifelse(nchar(!!rlang::sym(final_ind_dob)) == 5,
                                                         lubridate::as_date(as.numeric(!!rlang::sym(final_ind_dob)), origin = "1899-12-30"),
                                                         stringr::str_sub(string = start, start = 1, end = 10))),
                  !!rlang::sym(final_date_join) := ifelse(is.na(!!rlang::sym(final_date_join)), NA,
                                                  ifelse(nchar(!!rlang::sym(final_date_join)) == 5,
                                                         lubridate::as_date(as.numeric(!!rlang::sym(final_date_join)), origin = "1899-12-30"),
                                                         stringr::str_sub(string = start, start = 1, end = 10))))
  
  raw.left_member <- raw.left_member %>%
    dplyr::mutate(!!rlang::sym(final_ind_dob_left) := ifelse(is.na(!!rlang::sym(final_ind_dob_left)), NA,
                                                  ifelse(nchar(!!rlang::sym(final_ind_dob_left)) == 5,
                                                         lubridate::as_date(as.numeric(!!rlang::sym(final_ind_dob_left)), origin = "1899-12-30"),
                                                         stringr::str_sub(string = start, start = 1, end = 10))),
                  !!rlang::sym(final_date_join_left) := ifelse(is.na(!!rlang::sym(final_date_join_left)), NA,
                                                  ifelse(nchar(!!rlang::sym(final_date_join_left)) == 5,
                                                         lubridate::as_date(as.numeric(!!rlang::sym(final_date_join_left)), origin = "1899-12-30"),
                                                         stringr::str_sub(string = start, start = 1, end = 10))),
                  !!rlang::sym(final_date_left) := ifelse(is.na(!!rlang::sym(final_date_left)), NA,
                                                  ifelse(nchar(!!rlang::sym(final_date_left)) == 5,
                                                         lubridate::as_date(as.numeric(!!rlang::sym(final_date_left)), origin = "1899-12-30"),
                                                         stringr::str_sub(string = start, start = 1, end = 10))))
  
  
  raw.died_member <- raw.died_member %>%
    dplyr::mutate(!!rlang::sym(dob_died) := ifelse(is.na(!!rlang::sym(dob_died)), NA,
                                                  ifelse(nchar(!!rlang::sym(dob_died)) == 5,
                                                         lubridate::as_date(as.numeric(!!rlang::sym(dob_died)), origin = "1899-12-30"),
                                                         stringr::str_sub(string = start, start = 1, end = 10))),
                  !!rlang::sym(final_date_death) := ifelse(is.na(!!rlang::sym(final_date_death)), NA,
                                                  ifelse(nchar(!!rlang::sym(final_date_death)) == 5,
                                                         lubridate::as_date(as.numeric(!!rlang::sym(final_date_death)), origin = "1899-12-30"),
                                                         stringr::str_sub(string = start, start = 1, end = 10))),
                  !!rlang::sym(date_join_final_death) := ifelse(is.na(!!rlang::sym(date_join_final_death)), NA,
                                                  ifelse(nchar(!!rlang::sym(date_join_final_death)) == 5,
                                                         lubridate::as_date(as.numeric(!!rlang::sym(date_join_final_death)), origin = "1899-12-30"),
                                                         stringr::str_sub(string = start, start = 1, end = 10))))
...
if(!file.exists("inputs/environment.Rdata")) {
  cause_death_f <- tcltk::tk_select.list(dplyr::pull(df_mortality_long[,death_cause]) %>% unique, title = "Cause Death related to Women")
  flag_mortality <- impactR4PHU::check_mortality_flags(df_mortality = df_mortality_long,
...
overall_mort_plaus <- openxlsx::read.xlsx("resources/overall_plaus.xlsx",fillMergedCells = TRUE, sheet = "FSL") %>%
  dplyr::distinct()



results_mort <- impactR4PHU::create_mortality_plaus(df_mortality = flag_mortality,
...
results_mort_enum <- create_mortality_quality_report_phu(df_mortality = flag_mortality,
                                                         exp_sex_ratio = exp_sex_ratio,
                                                         exp_ratio_0_4 = exp_ratio_0_4,
                                                         exp_ratio_2_5 = exp_ratio_2_5,
                                                         exp_ratio_5_10 = exp_ratio_5_10,
