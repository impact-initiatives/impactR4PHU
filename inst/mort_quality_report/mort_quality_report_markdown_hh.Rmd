...
raw.main <- raw.main %>% 
  dplyr::mutate(num_days = as.numeric(date_dc_date - date_recall_date),
                ...
                pt_join = ifelse(is.na(num_join), 0,num_days * as.numeric(num_join)),
                pt_left = ifelse(is.na(num_left), 0,num_days * as.numeric(num_left)),
                pt_died = ifelse(is.na(num_died), 0,num_days * as.numeric(num_died)),
                pt_birth = ifelse(is.na(num_birth), 0,num_days * as.numeric(num_birth)),
