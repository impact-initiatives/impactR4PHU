...
overall_fsl_plaus <- openxlsx::read.xlsx(xlsxFile = "resources/overall_plaus.xlsx", fillMergedCells = TRUE, sheet = "FSL") %>%
  dplyr::distinct()
...
bind <- data.frame(`Indicator Score` = c("plaus_fcs","plaus_fcs","plaus_fcs","plaus_fcs","plaus_fcs","plaus_fcs",
                                         ...
                                         "plaus_rcsi","plaus_rcsi","plaus_rcsi","plaus_rcsi",
                                         "plaus_rcsi","plaus_rcsi","plaus_rcsi","plaus_rcsi",
                                         
                                         "plaus_hhs","plaus_hhs",
                                         
                                         "plaus_lcsi","plaus_lcsi","plaus_lcsi","plaus_lcsi","plaus_lcsi","plaus_lcsi",
...
overall_fsl_plaus_overall <- overall_fsl_plaus%>%
  ...
  dplyr::mutate(indscore = case_when(flag_name == "plaus_flag_severe_hhs"~paste0(indscore,"/10"),
                                     flag_name == "plaus_flag_sd_foodgroup" ~paste0(indscore,"/22"),
                                     flag_name == "plaus_sd_fcs" ~paste0(indscore,"/22"),
                                     flag_name == "plaus_flag_low_fcs" ~paste0(indscore,"/22"),
                                     flag_name == "plaus_flag_zero_fcs" ~paste0(indscore,"/22"),
                                     flag_name == "plaus_flag_high_fcs" ~paste0(indscore,"/22"),
                                     flag_name == "plaus_flag_full_fcs" ~paste0(indscore,"/22"),
                                     flag_name == "plaus_flag_meat_cereal_ratio" ~paste0(indscore,"/22"),
                                     
                                     
                                     flag_name == "plaus_flag_sd_rcsicoping" ~paste0(indscore,"/20"),
                                     flag_name == "plaus_sd_rcsi" ~paste0(indscore,"/20"),
                                     flag_name == "plaus_flag_high_rcsi" ~paste0(indscore,"/20"),
                                     flag_name == "plaus_flag_protein_rcsi" ~paste0(indscore,"/20"),
                                     
                                     
                                     flag_name == "plaus_flag_lcsi_coherence" ~paste0(indscore,"/18"),
                                     flag_name == "plaus_flag_lcsi_na" ~paste0(indscore,"/18"),
                                     flag_name == "plaus_flag_lcsi_severity" ~paste0(indscore,"/18"),
                                     
                                     flag_name == "plaus_prop_fc_flags" ~paste0(indscore,"/20"),
                                     flag_name == "plaus_corr.fcs_rcsi" ~paste0(indscore,"/20"),
                                     flag_name == "plaus_corr.fcs_hhs" ~paste0(indscore,"/20"),
                                     flag_name == "plaus_corr.hhs_rcsi" ~paste0(indscore,"/20"),
                                     flag_name == "plaus_flag_fcsrcsi_box" ~paste0(indscore,"/20"),
                                     flag_name == "plaus_flag_fcs_rcsi" ~paste0(indscore,"/20"),
