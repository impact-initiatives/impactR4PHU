...
if(all(fcs_check_columns %in% names(raw.flag.fcs))) {
  if(yes_no_team == "yes"){
    cat(paste0(paste0(rep("\n",2), collapse=""), paste0(rep("#",4), collapse=""), " ", "FCS Ridge by Team Distribution Plot"))
    for (i in list_teams) {
    cat(paste0(paste0(rep("\n",2), collapse=""), paste0(rep("#",5), collapse=""), " ", "<strong>",i,"</strong>"))
    list_enum <- raw.main %>% 
      dplyr::filter(!!rlang::sym(team) == i) %>% 
      dplyr::pull(!!rlang::sym(enumerator))
    (impactR4PHU::plot_ridge_distribution(raw.flag.fcs %>% 
...
if(all(fcs_check_columns %in% names(raw.flag.fcs))) {
  if(yes_no_team == "yes"){
    cat(paste0(paste0(rep("\n",2), collapse=""), paste0(rep("#",4), collapse=""), " ", "RCSI Ridge by Team Distribution Plot"))
    for (i in list_teams) {
    cat(paste0(paste0(rep("\n",2), collapse=""), paste0(rep("#",5), collapse=""), " ", "<strong>",i,"</strong>"))
    list_enum <- raw.main %>% 
      dplyr::filter(!!rlang::sym(team) == i) %>% 
