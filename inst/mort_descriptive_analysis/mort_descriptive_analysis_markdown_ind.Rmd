...
save.dfs(sorted_df,paste0("output/Mortality_combined_analysis_toc_", strings['out_date'], ".xlsx"), use_template = F)
...
srvey_mortality <- srvyr::as_survey_design(df_mortality_long %>%
  ...
  results.summary <- rbind(crude,under_5) %>%
   rename(`point.est` = "x",
          `95%lci` = "x_low",
          `95%uci` = "x_upp") %>%
...
results.summary_gender <- rbind(crude_gender,under5_gender) %>%
  dplyr::relocate(variable, .before = 1)
```

```{r, results='asis'}
DT::datatable(results.summary_gender)
```

```{r, include=FALSE}
plot_results.summary_gender <- ggplot2::ggplot(results.summary_gender %>%
                                               mutate(variable = case_when(variable == "cmr"~"Crude",
                                                                           variable == "u5mr"~"Under 5")), ggplot2::aes(x = variable)) +
  ggplot2::geom_hline(yintercept=1, linetype='dotted', color = 'black', size =1)+
  ggplot2::geom_hline(yintercept=2, linetype='dotted', color = 'red', size =1)+
  ...
  ggplot2::geom_point(ggplot2::aes(y = point.est), color = "blue")+
  ggplot2::geom_text(ggplot2::aes(x = variable, y = point.est, label = point.est, hjust = -0.5), size = 3, color = "blue", fontface = "bold")+
  ggplot2::scale_y_continuous(limits=c(0, if(max(results.summary_gender$`95%uci`)<2){
    2
  } else {
    max(results.summary_gender$`95%uci`)
  }))+
  ggplot2::theme(legend.position = "none", axis.title.y = ggplot2::element_blank())+
  ggplot2::xlab("Overall Mortality Rates")+
  ggplot2::labs(caption = c("Black Dotted Line: Crude Threshold (WHO)", "Red Dotted Line: Under 5 Threshold (WHO)")) +
...
results.summary_age_group <- rbind(crude_age_group,under5_age_group) %>%
  dplyr::relocate(variable, .before = 1)
```

```{r, results='asis'}
DT::datatable(results.summary_age_group)
```

```{r, include=FALSE}
plot_results.summary_age_group <- ggplot2::ggplot(results.summary_age_group %>%
                                               mutate(variable = case_when(variable == "cmr"~"Crude",
                                                                           variable == "u5mr"~"Under 5")), ggplot2::aes(x = variable)) +
  ggplot2::geom_hline(yintercept=1, linetype='dotted', color = 'black', size =1)+
  ggplot2::geom_hline(yintercept=2, linetype='dotted', color = 'red', size =1)+
  ...
  ggplot2::geom_point(ggplot2::aes(y = point.est), color = "blue")+
  ggplot2::geom_text(ggplot2::aes(x = variable, y = point.est, label = point.est, hjust = -0.5), size = 3, color = "blue", fontface = "bold")+
  ggplot2::scale_y_continuous(limits=c(0, if(max(results.summary_age_group$`95%uci`)<2){
    2
  } else {
    max(results.summary_age_group$`95%uci`)
  }))+
  ggplot2::theme(legend.position = "none", axis.title.y = ggplot2::element_blank())+
  ggplot2::xlab("Overall Mortality Rates")+
  ggplot2::labs(caption = c("Black Dotted Line: Crude Threshold (WHO)", "Red Dotted Line: Under 5 Threshold (WHO)")) +
...
results.summary_pop_group <- rbind(crude_pop_group,under5_pop_group) %>%
  dplyr::relocate(variable, .before = 1)
```

```{r, results='asis'}
DT::datatable(results.summary_pop_group)
```

```{r, include=FALSE}
plot_results.summary_pop_group <- ggplot2::ggplot(results.summary_pop_group %>%
                                               mutate(variable = case_when(variable == "cmr"~"Crude",
                                                                           variable == "u5mr"~"Under 5")), ggplot2::aes(x = variable)) +
  ggplot2::geom_hline(yintercept=1, linetype='dotted', color = 'black', size =1)+
  ggplot2::geom_hline(yintercept=2, linetype='dotted', color = 'red', size =1)+
  ...
  ggplot2::geom_point(ggplot2::aes(y = point.est), color = "blue")+
  ggplot2::geom_text(ggplot2::aes(x = variable, y = point.est, label = point.est, hjust = -0.5), size = 3, color = "blue", fontface = "bold")+
  ggplot2::scale_y_continuous(limits=c(0, if(max(results.summary_pop_group$`95%uci`)<2){
    2
  } else {
    max(results.summary_pop_group$`95%uci`)
  }))+
  ggplot2::theme(legend.position = "none", axis.title.y = ggplot2::element_blank())+
  ggplot2::xlab("Overall Mortality Rates")+
  ggplot2::labs(caption = c("Black Dotted Line: Crude Threshold (WHO)", "Red Dotted Line: Under 5 Threshold (WHO)")) +
...
if(is.null(cluster)){
  ...
  under_5_admin1 <- srvey_mortality %>%
    ...
    dplyr::mutate_at(vars(c(x,x_low,x_upp)),~round(.,2)) %>%
    mutate(variable = "u5mr")
  results.summary_admin1 <- rbind(crude_admin1,under_5_admin1) %>%
   rename(`point.est` = "x",
          `95%lci` = "x_low",
          `95%uci` = "x_upp") %>%
   relocate(variable, .before = 1)
...
```{r, results='asis'}
DT::datatable(results.summary_admin1)
```

```{r, include=FALSE}
plot_results.summary_admin1 <- ggplot2::ggplot(results.summary_admin1 %>%
                                               mutate(variable = case_when(variable == "cmr"~"Crude",
                                                                           variable == "u5mr"~"Under 5")), ggplot2::aes(x = variable)) +
  ggplot2::geom_hline(yintercept=1, linetype='dotted', color = 'black', size =1)+
  ggplot2::geom_hline(yintercept=2, linetype='dotted', color = 'red', size =1)+
  ...
  ggplot2::geom_point(ggplot2::aes(y = point.est), color = "blue")+
  ggplot2::geom_text(ggplot2::aes(x = variable, y = point.est, label = point.est, hjust = -0.5), size = 3, color = "blue", fontface = "bold")+
  ggplot2::scale_y_continuous(limits=c(0, if(max(results.summary_admin1$`95%uci`)<2){
    2
  } else {
    max(results.summary_admin1$`95%uci`)
  }))+
  ggplot2::theme(legend.position = "none", axis.title.y = ggplot2::element_blank())+
  ggplot2::xlab("Overall Mortality Rates")+
  ggplot2::labs(caption = c("Black Dotted Line: Crude Threshold (WHO)", "Red Dotted Line: Under 5 Threshold (WHO)")) +
...
results.summary_admin2 <- rbind(crude_admin2,under5_admin2) %>%
  dplyr::relocate(variable, .before = 1)
```

```{r, results='asis'}
DT::datatable(results.summary_admin2)
```

```{r, include=FALSE}
plot_results.summary_admin2 <- ggplot2::ggplot(results.summary_admin2 %>%
                                               mutate(variable = case_when(variable == "cmr"~"Crude",
                                                                           variable == "u5mr"~"Under 5")), ggplot2::aes(x = variable)) +
  ggplot2::geom_hline(yintercept=1, linetype='dotted', color = 'black', size =1)+
  ggplot2::geom_hline(yintercept=2, linetype='dotted', color = 'red', size =1)+
  ...
  ggplot2::geom_point(ggplot2::aes(y = point.est), color = "blue")+
  ggplot2::geom_text(ggplot2::aes(x = variable, y = point.est, label = point.est, hjust = -0.5), size = 3, color = "blue", fontface = "bold")+
  ggplot2::scale_y_continuous(limits=c(0, if(max(results.summary_admin2$`95%uci`)<2){
    2
  } else {
    max(results.summary_admin2$`95%uci`)
  }))+
  ggplot2::theme(legend.position = "none", axis.title.y = ggplot2::element_blank())+
  ggplot2::xlab("Overall Mortality Rates")+
  ggplot2::labs(caption = c("Black Dotted Line: Crude Threshold (WHO)", "Red Dotted Line: Under 5 Threshold (WHO)")) +
...
results.summary_admin1_pop_group <- rbind(crude_admin1_pop_group,under5_admin1_pop_group) %>%
  dplyr::relocate(variable, .before = 1)
```

```{r, results='asis'}
DT::datatable(results.summary_admin1_pop_group)
```

```{r, include=FALSE}
plot_results.summary_admin1_pop_group <- ggplot2::ggplot(results.summary_admin1_pop_group %>%
                                               mutate(variable = case_when(variable == "cmr"~"Crude",
                                                                           variable == "u5mr"~"Under 5")), ggplot2::aes(x = variable)) +
  ggplot2::geom_hline(yintercept=1, linetype='dotted', color = 'black', size =1)+
  ggplot2::geom_hline(yintercept=2, linetype='dotted', color = 'red', size =1)+
  ...
  ggplot2::geom_point(ggplot2::aes(y = point.est), color = "blue")+
  ggplot2::geom_text(ggplot2::aes(x = variable, y = point.est, label = point.est, hjust = -0.5), size = 3, color = "blue", fontface = "bold")+
  ggplot2::scale_y_continuous(limits=c(0, if(max(results.summary_admin1_pop_group$`95%uci`)<2){
    2
  } else {
    max(results.summary_admin1_pop_group$`95%uci`)
  }))+
  ggplot2::theme(legend.position = "none", axis.title.y = ggplot2::element_blank())+
  ggplot2::xlab("Overall Mortality Rates")+
  ggplot2::labs(caption = c("Black Dotted Line: Crude Threshold (WHO)", "Red Dotted Line: Under 5 Threshold (WHO)")) +
...
results.summary_hoh_gender <- rbind(crude_hoh_gender,under5_hoh_gender) %>%
  dplyr::relocate(variable, .before = 1)
```

```{r, results='asis'}
DT::datatable(results.summary_hoh_gender)
```

```{r, include=FALSE}
plot_results.summary_hoh_gender <- ggplot2::ggplot(results.summary_hoh_gender %>%
                                               mutate(variable = case_when(variable == "cmr"~"Crude",
                                                                           variable == "u5mr"~"Under 5")), ggplot2::aes(x = variable)) +
  ggplot2::geom_hline(yintercept=1, linetype='dotted', color = 'black', size =1)+
  ggplot2::geom_hline(yintercept=2, linetype='dotted', color = 'red', size =1)+
  ...
  ggplot2::geom_point(ggplot2::aes(y = point.est), color = "blue")+
  ggplot2::geom_text(ggplot2::aes(x = variable, y = point.est, label = point.est, hjust = -0.5), size = 3, color = "blue", fontface = "bold")+
  ggplot2::scale_y_continuous(limits=c(0, if(max(results.summary_hoh_gender$`95%uci`)<2){
    2
  } else {
    max(results.summary_hoh_gender$`95%uci`)
  }))+
  ggplot2::theme(legend.position = "none", axis.title.y = ggplot2::element_blank())+
  ggplot2::xlab("Overall Mortality Rates")+
  ggplot2::labs(caption = c("Black Dotted Line: Crude Threshold (WHO)", "Red Dotted Line: Under 5 Threshold (WHO)")) +
...
results.summary_income_source <- rbind(crude_income_source,under5_income_source) %>%
  dplyr::relocate(variable, .before = 1)
```

```{r, results='asis'}
DT::datatable(results.summary_income_source)
```

```{r, include=FALSE}
plot_results.summary_income_source <- ggplot2::ggplot(results.summary_income_source %>%
                                               mutate(variable = case_when(variable == "cmr"~"Crude",
  ...
  ggplot2::geom_point(ggplot2::aes(y = point.est), color = "blue")+
  ggplot2::geom_text(ggplot2::aes(x = variable, y = point.est, label = point.est, hjust = -0.5), size = 3, color = "blue", fontface = "bold")+
  ggplot2::scale_y_continuous(limits=c(0, if(max(results.summary_income_source$`95%uci`)<2){
    2
  } else {
    max(results.summary_income_source$`95%uci`)
  }))+
  ggplot2::theme(legend.position = "none", axis.title.y = ggplot2::element_blank())+
  ggplot2::xlab("Overall Mortality Rates")+
  ggplot2::labs(caption = c("Black Dotted Line: Crude Threshold (WHO)", "Red Dotted Line: Under 5 Threshold (WHO)")) +
