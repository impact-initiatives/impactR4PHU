...
(impactR4PHU::plot_age_pyramid(table_age_pyramide %>% 
                                 dplyr::mutate(calc_final_age_years = as.numeric(calc_final_age_years)),
...
if(nrow(overall_flag)>0) {
  cat(paste0(paste0(rep("\n",2), collapse=""), paste0(rep("#",2), collapse=""), " ", "WATER CONSUMPTION {.tabset .tabset-fade}"))
