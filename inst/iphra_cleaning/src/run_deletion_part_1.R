...
strings <- c(
  ...
  ), # provide a short name for filenames of output documents (e.g. "POL_PDM")      # this string is only used for creating titles for output documents
  ...
  filename.data = choose.files(
    caption = if (language_assessment == "English") {
