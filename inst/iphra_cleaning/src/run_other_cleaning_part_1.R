...
translation <-  svDialogs::dlg_list(choices = c("Yes/Oui","No/Non"), title= if(language_assessment == "English"){
...
strings <- c(
  language_other = if(translation == "Yes/Oui"){
    svDialogs::dlg_list(choices = c("French","Arabic", "Spanish"), title= if(language_assessment == "English"){
  ...
  api = if(translation == "Yes/Oui"){
    svDialogs::dlg_list(choices = c("Microsoft","DeepL","No Api"), title= if(language_assessment == "English"){
  ...
  api_key = if(translation == "Yes/Oui"){
    svDialogs::dlg_input(message=if(language_assessment == "English"){
