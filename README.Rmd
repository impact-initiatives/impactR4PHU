...
After running all the line in the run_fsl_quality_report.R, below are the set of inputs that are required for you to select/fill.
<strong><p style = "color:red">Please make sure to select</p></strong> 
