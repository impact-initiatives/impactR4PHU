...
check_iycf_flags <- function(.dataset,
  ...
  if(!all(c(iycf_8,foods,liquids) %in% names(.dataset))) {
  ...
  if(!all(c("iycf_mdd_score", iycf_8) %in% names(.dataset))) {
  ...
  if(!all(c(iycf_4, iycf_6b_num, iycf_6c_num, iycf_6d_num) %in% names(.dataset))) {
  ...
  if(!all(c(iycf_7b, iycf_7d, iycf_7i, iycf_7j, iycf_7k, iycf_7l, iycf_7m) %in% names(.dataset))) {
