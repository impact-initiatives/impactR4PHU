...
- fsl_hdds_veg:
  ...
  the name of the variable that indicates if vegetables were consumed in
  the last 24 hours

- fsl_hdds_fruit:

  the name of the variable that indicates if fruit were consumed in the
  last 24 hours
...
- fsl_hdds_oil:
  ...
  the name of the variable that indicates if oil was consumed in the
  last 24 hours
...
- fsl_hdds_yes_value:
  ...
  the "yes" choice value of the variables that indicates the HDDS
...
- fsl_lcsi_stress:
  ...
  the name of the variable that indicates the calculation of the stress
  LCSI strategy

- fsl_lcsi_crisis:

  the name of the variable that indicates the calculation of the crisis
  LCSI strategy
...
- fsl_lcsi_cat_yes:
  ...
  the name of the variable that indicates the highest category of the
  LCSI strategy used yes

- fsl_lcsi_cat_exhaust:

  the name of the variable that indicates the highest category of the
  LCSI strategy used exhaustively
...
- fsl_lcsi_yes_value:
  ...
  the "yes" choice value of the variables that indicates the LCSI
  strategies

- fsl_fcs_cat:

  the name of the variable that indicates the food consumption score
  category
...
- fsl_rcsi_cat:
  ...
  the name of the variable that indicates the reduced coping strategy
  index category
...
- fsl_hhs_cat:
  ...
  the name of the variable that indicates the household hunger scale
  category
...
- fsl_hdds_cat:
  ...
  the name of the variable that indicates the household dietary
  diversity score category
...
- fsl_fc_cell:
  ...
  the name of the variable that indicates the food consumption matrix
  score
...
a dataframe that includes all the logical flags related to food security
and livelihoods. This includes: - flag_meat_cereal_ratio -
flag_low_cereal - flag_low_fcs - flag_high_fcs - flag_low_oil -
flag_sd_foodgroup - flag_protein_rcsi - flag_fcs_rcsi - flag_high_rcsi -
flag_rcsi_children - flag_fcsrcsi_box - flag_sd_rcsicoping -
flag_severe_hhs - flag_lcsi_coherence - flag_lcsi_severity -
flag_lcsi_na - flag_fc_cell - flag_low_sugar_cond_hdds
...
#> Error in check_fsl_flags(.dataset = df, tool.survey = tool.survey): unused argument (tool.survey = tool.survey)
```
